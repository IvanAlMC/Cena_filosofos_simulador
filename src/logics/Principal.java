...
public class Principal {
     ...
     */
    public Principal(ControlGUI clase10Control, int quantity, int time) {
        ...
        // Se crea el Array para contener las instancias de Tenedores:
        Fork[] tenedor = new Fork[this.quantity];
        // Se crea el Array para contener las instancias de Filósofos:
        ...
        for (int i = 0; i < filosofo.length; i++) {
            ...
            filosofo[i] = new Philosopher(i, tenedor[i], tenedor[(i + 1) % quantity], comensal, jLabel_F[i], jLabel_T[i], jLabel_T[(i + 1) % quantity], log, jTextField_C[i], time, quantity);
        }
