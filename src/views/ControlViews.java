...
public class ControlViews extends GenericView {

    /**
     * Creates new form ControlViews
     */
    public ControlViews() {
    ...
    private void initComponents() {
        ...
        jTextField_Cont12 = new javax.swing.JTextField();
        ...
        jButton_Iniciar.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jButton_Finalizar.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jTextField_Cont6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField_Cont6ActionPerformed(evt);
            }
        });

        jLabel19.setText("Cantidad filosofos");

        jLabel20.setText("Tiempo Max Comida");

        jTextField_Cont12.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField_Cont12ActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTextField_Cont12, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jTextField_Cont6, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jTextField_Cont12, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private void jButton_IniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_IniciarActionPerformed
        ...
        int quantity = validaInt(jTextField_Cont6.getText());
        int time = validaInt(jTextField_Cont12.getText());
        if (quantity >= 3 && time > 0) {
            if(quantity > 10) {
                jPanel2.setVisible(false);
                jPanel8.setVisible(false);
            }
            new Principal(clase10Control, quantity, time);
            System.out.println("---------------------------------------------------" + jTextField_Cont6.getText());
    ...
    private void jButton_FinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_FinalizarActionPerformed
        ...
        try {
            sleep(3000);
            int quantity = validaInt(jTextField_Cont6.getText());
            Reports dialog = new Reports(this, true, quantity);
            dialog.setVisible(true);
        } catch (InterruptedException ex) {
            System.out.println("Error. Descripción: " + ex);
        }
    ...
    private void jButton_ResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ResetActionPerformed
        ...
        this.dispose();
        JFrame v10control = new ControlViews();
    }//GEN-LAST:event_jButton_ResetActionPerformed

    private void jTextField_Cont12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField_Cont12ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextField_Cont12ActionPerformed

    private void jTextField_Cont6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField_Cont6ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextField_Cont6ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ControlViews.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ControlViews().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jTextField_Cont12;
